...
matlabbatch{4}.spm.stats.results.conspec(1).threshdesc = 'FDR';%changed to FDR to be consistent with Devin's paper
...
matlabbatch{8}.spm.stats.results.conspec(1).threshdesc = 'FDR';
...
matlabbatch{12}.spm.stats.results.conspec(1).threshdesc = 'FDR';
...
matlabbatch{16}.spm.stats.results.conspec(1).threshdesc = 'FDR';
