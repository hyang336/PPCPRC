...
PYTENSOR_FLAGS='blas__ldflags=-lflexiblas -lgfortran' python /home/hyang336/PPCPRC/analyses/test_phase/HSSM/HSSM_fit022_binary.py --signal $1 --regressor $2 --model $3 
